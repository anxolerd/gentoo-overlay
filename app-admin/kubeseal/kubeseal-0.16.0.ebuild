...
# cd $(mktemp -d)
# PV="0.16.0"
# wget "https://github.com/bitnami-labs/sealed-secrets/archive/v${PV}.tar.gz"
# tar -xvzf "v${PV}.tar.gz"
# sed -Ee 's/^(.+) h1:.+$/\t"\1"/g' "sealed-secrets-${PV}/go.sum" > go.sum.out
EGO_SUM=(
...
"github.com/bitnami-labs/flagenv v0.0.0-20190607135054-a87af7a1d6fc/go.mod"
...
"github.com/googleapis/gnostic v0.0.0-20171211024024-933c109c13ce"
"github.com/googleapis/gnostic v0.0.0-20171211024024-933c109c13ce/go.mod"
...
"github.com/mkmik/multierror v0.3.0/go.mod"
...
"github.com/throttled/throttled v2.2.2+incompatible/go.mod"
...
"k8s.io/api v0.16.8"
"k8s.io/api v0.16.8/go.mod"
"k8s.io/api v0.19.4/go.mod"
"k8s.io/apiextensions-apiserver v0.19.4/go.mod"
"k8s.io/apimachinery v0.16.8"
"k8s.io/apimachinery v0.16.8/go.mod"
"k8s.io/apimachinery v0.19.4/go.mod"
"k8s.io/apiserver v0.19.4/go.mod"
"k8s.io/cli-runtime v0.19.4/go.mod"
"k8s.io/client-go v0.16.8"
"k8s.io/client-go v0.16.8/go.mod"
"k8s.io/client-go v0.19.4/go.mod"
"k8s.io/code-generator v0.16.8"
"k8s.io/code-generator v0.16.8/go.mod"
"k8s.io/code-generator v0.19.4/go.mod"
"k8s.io/component-base v0.19.4/go.mod"
...
"k8s.io/kubectl v0.19.4/go.mod"
"k8s.io/kubernetes v1.13.0/go.mod"
"k8s.io/metrics v0.19.4/go.mod"
...
SOURCE_PN="github.com/bitnami-labs/sealed-secrets"
